...
export namespace ObligationCreatedEvent {
  export type InputTuple = [cid: string, provider: AddressLike];
  export type OutputTuple = [cid: string, provider: string];
...
export interface ObligationManager extends BaseContract {
  ...
  createObligation: TypedContractMethod<[cid: string], [void], "nonpayable">;
  ...
  updateStatus: TypedContractMethod<
    [cid: string, status: BigNumberish],
    [void],
    "nonpayable"
  >;
  ...
  filters: {
    "ObligationCreated(string,address)": TypedContractEvent<
      ObligationCreatedEvent.InputTuple,
      ObligationCreatedEvent.OutputTuple,
      ObligationCreatedEvent.OutputObject
    >;
